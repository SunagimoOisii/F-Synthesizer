...
Write-Host "[1/9] help output"
& $exePath --help | Out-Host

Write-Host "[2/9] cli success run (default.json)"
...
Write-Host "[3/9] cli success run (channel_minimal.json)"
...
Write-Host "[4/9] cli success run (channel_full.json)"
...
Write-Host "[5/9] cli success run (mix_all_mute.json)"
...
Write-Host "[6/9] cli failure run (channel_mix_invalid.json)"
...
Write-Host "[7/9] cli failure run (missing config)"
...
Write-Host "[8/9] cli failure run (channel_invalid.json)"
...
Write-Host "[9/9] gui launch smoke (2 sec)"
