...
- `docs/synth-methods/foundation-contract.md`（Frozen）
...
- 現状仕様:
  ...
  - Destination（保存時の正規名）: `none/pitchMul/amp/filterCutoffHz`
  - 読込互換: `pitch` / `filterCutoff` も受理
  - `pan`: 現時点は非採用（ConfigLoad 非受理）
  - 方式固有 destination: Phase 1 として `fm.index` を実装（`source.type=fm` 限定で受理・適用）
...
0. 基盤契約確認:
   - `docs/synth-methods/foundation-contract.md` の 2.1〜2.6 を先に確認
   - 監査根拠は `docs/synth-methods/foundation-audit-2026-03-05.md` を参照
1. Core実装:
...
- 現状:
  - FM source の Modulation Destination で `fm.index` を GUI から選択可能（Phase 1）。
- Parameter Smoothing 方針（Phase E 判定）:
  - 現時点は未接続（判断のみ確定）
...
- Generated at: 2026-03-08 09:05:24

### Foundation Files

- `include/SynthEngine/SynthEngine.h` (updated: 2026-03-08 08:44:41)
- `include/SynthEngine/Filter.h` (updated: 2026-02-23 19:58:17)
- `include/SynthEngine/Modulation.h` (updated: 2026-03-08 08:12:07)
- `src/SynthEngine/Filter.cpp` (updated: 2026-03-03 03:42:24)
- `src/SynthEngine/Modulation.cpp` (updated: 2026-03-08 08:12:14)
- `src/SynthEngine/Renderer.cpp` (updated: 2026-03-08 08:45:08)
- `src/SynthEngine/Voices.cpp` (updated: 2026-03-08 08:45:00)
- `src/config/ConfigLoad.cpp` (updated: 2026-03-08 08:43:09)
- `src/config/ConfigJSONUtils.cpp` (updated: 2026-03-08 08:44:21)
- `src/gui/GUIChannelEditor.cpp` (updated: 2026-03-08 08:29:07)
- `src/gui/GUIConfigUtils.cpp` (updated: 2026-03-08 08:13:29)
<!-- AUTO-GENERATED:END -->
