...
- 現状仕様:
  ...
  - 方式固有 destination: 命名規約のみ確定（`<sourceKind>.<parameterId>`、例: `fm.index`）
...
- Generated at: 2026-03-08 08:08:58
...
- `src/SynthEngine/Voices.cpp` (updated: 2026-03-08 08:07:21)
- `src/config/ConfigLoad.cpp` (updated: 2026-02-23 22:26:30)
- `src/config/ConfigJSONUtils.cpp` (updated: 2026-03-08 07:50:54)
- `src/gui/GUIChannelEditor.cpp` (updated: 2026-03-08 07:06:54)
- `src/gui/GUIConfigUtils.cpp` (updated: 2026-03-05 01:15:41)
<!-- AUTO-GENERATED:END -->
